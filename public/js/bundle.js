...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"alertsHandler.js":[function(require,module,exports) {
"use strict";
...
exports.submitlistener = exports.submitBtn = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _alertsHandler = require("./alertsHandler");
...
var submitBtn = document.querySelector(".form--login"); // document.querySelector(".login--email_ph").value = "";
// document.querySelector(".login--password_ph").value = "";

exports.submitBtn = submitBtn;

var submitlistener = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("Pressed");
            _context.prev = 1;
            e.preventDefault(); // console.log("pressed");
          ...
          case 7:
            ...
            if (res.data.message === "Success") {
              (0, _alertsHandler.showAlerts)("success", "logged in!");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500); // alert("User logged in successfully");
              // window.setTimeout(() => {
              //   location.assign("/");
              // }, 1500);
            }
          ...
          case 11:
            ...
            (0, _alertsHandler.showAlerts)("error", _context.t0.response.data.message);
  ...
  return function submitlistener(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.submitlistener = submitlistener;
},{"axios":"../../node_modules/axios/index.js","./alertsHandler":"alertsHandler.js"}],"forgotPassword.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.submitlistenerForgotPassword = exports.submitBtnForgotPassword = void 0;
...
var submitBtnForgotPassword = document.querySelector(".form--forgotPassword"); // document.querySelector(".login--email_ph").value = "";
// document.querySelector(".login--password_ph").value = "";

exports.submitBtnForgotPassword = submitBtnForgotPassword;

var submitlistenerForgotPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var email, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            email = document.querySelector("#emailFP").value;
            _context.next = 7;
            return (0, _axios.default)({
              method: "POST",
          ...
          case 7:
            ...
            if (res.data.status === "Success") {
              (0, _alertsHandler.showAlerts)("success", "Reset Link Sent to your registered email");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500); // alert("User logged in successfully");
              // window.setTimeout(() => {
  ...
  return function submitlistenerForgotPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.submitlistenerForgotPassword = submitlistenerForgotPassword;
},{"axios":"../../node_modules/axios/index.js","./alertsHandler":"alertsHandler.js"}],"resetPassword.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.submitlistenerResetPassword = exports.submitBtnResetPassword = void 0;
...
var submitBtnResetPassword = document.querySelector(".form--resetPassword"); // document.querySelector(".login--email_ph").value = "";

exports.submitBtnResetPassword = submitBtnResetPassword;
console.log("Hello"); // document.querySelector(".login--password_ph").value = "";

var submitlistenerResetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var passNew, passNewConfirm, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passNew = document.querySelector("#password-new").value;
            passNewConfirm = document.querySelector("#password-new-confirm").value;
            console.log(document.URL);
            _context.next = 9;
            return (0, _axios.default)({
              method: "PATCH",
              url: "/trevell/api/v1/users/resetPassword/".concat(document.URL.split("/")[5]),
              data: {
                password: passNew,
          ...
          case 9:
            ...
            if (res.data.message === "Password Changed") {
              (0, _alertsHandler.showAlerts)("success", "password changed");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500); // alert("User logged in successfully");
              // window.setTimeout(() => {
  ...
  return function submitlistenerResetPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.submitlistenerResetPassword = submitlistenerResetPassword;
},{"axios":"../../node_modules/axios/index.js","./alertsHandler":"alertsHandler.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoic3RpY2t0cmljazMxODEiLCJhIjoiY2t4ZGdvc3R0NGJzODJ5cHpxdzFrdHRlMSJ9.APwO475y1HQ8gWFWMknEUg";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/sticktrick3181/ckxdhwr8o1d9i15pherq73lx8",
    // style URL
  ...
  locations.forEach(function (loc) {
    var _loc$coordinates = _slicedToArray(loc.coordinates, 2),
        a = _loc$coordinates[0],
        b = _loc$coordinates[1];

    loc.coordinates = [b, a]; //Adding a marker
...
},{}],"userFormSubmit.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updationFuntionality = exports.updationFrom = exports.updatingPasswordForm = exports.updatePasswordFunctionality = void 0;
...
var updatingPasswordForm = document.getElementById("updating--password--form");
exports.updatingPasswordForm = updatingPasswordForm;
var updationFrom = document.querySelector(".form-user-data");
exports.updationFrom = updationFrom;

var updationFuntionality = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var form, newUser;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            // console.log("done");
            e.preventDefault();
            form = new FormData(); // const name = document.getElementById("name").value;
            // console.log(name);

            form.append("firstName", document.getElementById("name").value.split(" ")[0]);
            form.append("lastName", document.getElementById("name").value.split(" ")[1]); // const [firstName, lastName] = name.split(" ");
          ...
          case 9:
            ...
            if (newUser.data.status === "Success") {
              (0, _alertsHandler.showAlerts)("success", "updated successfully");
              window.setTimeout(function () {
          ...
          case 13:
            ...
            (0, _alertsHandler.showAlerts)("success", "Reload for the applied changes"); // console.log(err);
  ...
  return function updationFuntionality(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.updationFuntionality = updationFuntionality;

var updatePasswordFunctionality = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var existingPassword, newPassword, confirmPassword, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            // console.log("pressed");
            //   console.log("done");
            existingPassword = document.getElementById("password-current").value; // console.log(existingPassword);

            newPassword = document.getElementById("password").value; // console.log(newPassword);

            confirmPassword = document.getElementById("password-confirm").value; // console.log(confirmPassword);
          ...
          case 7:
            ...
            if (result.data.status === "Success") {
              (0, _alertsHandler.showAlerts)("success", "Password updated successfully");
              window.setTimeout(function () {
          ...
          case 11:
            ...
            (0, _alertsHandler.showAlerts)("error", _context2.t0.response.data.message);
  ...
  return function updatePasswordFunctionality(_x2) {
    return _ref2.apply(this, arguments);
  };
}(); // updationFrom.addEventListener("submit", updationFuntionality);


exports.updatePasswordFunctionality = updatePasswordFunctionality;
},{"./alertsHandler":"alertsHandler.js","axios":"../../node_modules/axios/index.js"}],"signup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.signupForm = exports.newUser = void 0;
...
var newUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var fname, lname, email, password, passwordC, city, state, result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordC = document.querySelector("#passwordConfirm-signup").value;
            city = document.querySelector("#city").value;
            state = document.querySelector("#state").value; // console.log({
            //   firstName: fname,
            //   lastName: lname,
            //   email: email,
            //   password: password,
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                password: password,
                passwordConfirm: passwordC,
                address: "".concat(city, ",").concat(state, ",INDIA")
              }
            });
          ...
          case 11:
            ...
            if (result.data.message === "Success") {
              (0, _alertsHandler.showAlerts)("success", "Signed in!");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500); // alert("User logged in successfully");
              // window.setTimeout(() => {
          ...
          case 15:
            _context.prev = 15;
            _context.t0 = _context["catch"](0);
            (0, _alertsHandler.showAlerts)("error", e.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alertsHandler":"alertsHandler.js"}],"stripe.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bookTrip = void 0;
...
var bookTrip = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tripId) {
    var stripe, session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51KRu9ISCrnTbnttc94FRtrmhfZMdL0J1zAMJyKp5S8LGk48pFBeejw6VLu03kXtlTpXGCEWaJTqiftoU7MhitsCM00Pwl1PaDW");
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("/trevell/api/v1/bookings/checkoutSession/".concat(tripId));
          ...
          case 4:
            ...
            if (session.data.status === "success") {
              (0, _alertsHandler.showAlerts)("success", "Being redirected to the merchant");
              window.setTimeout(function () {
                location.assign("".concat(session.data.session.url));
              }, 1500);
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](1);
            (0, _alertsHandler.showAlerts)("error", "Please try again!!");
  ...
  return function bookTrip(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookTrip = bookTrip;
},{"axios":"../../node_modules/axios/index.js","./alertsHandler":"alertsHandler.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _userFormSubmit = require("./userFormSubmit");
...
console.log("Bundle working fine just checking"); //LOGIN

if (_login.submitBtn) _login.submitBtn.addEventListener("submit", _login.submitlistener); //FORGOT PASSWORD

if (_forgotPassword.submitBtnForgotPassword) _forgotPassword.submitBtnForgotPassword.addEventListener("submit", _forgotPassword.submitlistenerForgotPassword); //RESET PASSWORD

if (_resetPassword.submitBtnResetPassword) _resetPassword.submitBtnResetPassword.addEventListener("submit", _resetPassword.submitlistenerResetPassword); //MAP
...
if (document.querySelector(".nav__el--logout")) {
  document.querySelector(".nav__el--logout").addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var res;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              res = _context.sent;
              (0, _alertsHandler.showAlerts)("success", "logged out successfully!");
              window.setTimeout(function () {
                location.assign("/user/login");
              }, 1500); //   document.querySelector(".login--email_ph").value = "";
              //   document.querySelector(".login--password_ph").value = "";
...
if (document.querySelector(".user-view__menu")) _userFormSubmit.updationFrom.addEventListener("submit", _userFormSubmit.updationFuntionality); //new user signup
