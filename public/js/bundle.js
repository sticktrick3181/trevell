      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("Current user photo"); // console.log(form);
          ...
          case 16:
            _context.prev = 16;
            _context.t0 = _context["catch"](0);
            (0, _alertsHandler.showAlerts)("success", "Reload for the applied changes");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            _context2.prev = 1;
            console.log("pressed"); //   console.log("done");

            existingPassword = document.getElementById("password-current").value;
...
var newUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var fname, lname, email, password, passwordC, result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordC = document.querySelector("#passwordConfirm-signup").value; // console.log({
            //   firstName: fname,
            //   lastName: lname,
            //   email: email,
            //   password: password,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://localhost:3000/trevell/api/v1/bookings/checkoutSession/".concat(tripId));
...
console.log("Bundle working"); //LOGIN
...
if (document.querySelector("#book-trip")) {
  ...
  bookBtn.addEventListener("click", function (e) {
    ...
    var _e$target$dataset = e.target.dataset,
        ...
        userInfo = _e$target$dataset.userInfo;
